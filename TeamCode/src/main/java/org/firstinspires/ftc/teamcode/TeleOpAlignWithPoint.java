 ...
 */
@Config
@TeleOp(name= "TeleOP bun", group = "advanced")
public class TeleOpAlignWithPoint extends LinearOpMode {
    ...
    private Vector2d targetPosition = new Vector2d(0, -25);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            // start teoretic la teleop sa speram ca merge facem o cruce + why are you norris
            if(gamepad1.left_bumper){
                if(intakeMotorSS==false)
                {
